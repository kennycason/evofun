...
class EvoFuncEvolveEntropy {
    ...
    private var organism = Organism(dna = Genetic.buildDNA(genesCount), worldWidth, worldHeight, Organism.GeneExpressionOrder.RANDOM)
    private var mostFitOrganism = Organism(dna = Genetic.buildDNA(genesCount), worldWidth, worldHeight, Organism.GeneExpressionOrder.RANDOM)
